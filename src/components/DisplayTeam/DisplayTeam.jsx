...
// console.log(detailsData)
  ...
  return (
    <div className="bg-purple-400 p-4">
      ...
      {
      !loading && (detailsData.map(player => <Team  key={player.id} player={player}> </Team>))
    
}
</div>
<div className="mx-auto text-center m-1 lg:m-3"><button onClick={deleteTeam} className="text-sm lg:text-lg font-bold text-white bg-red-800 border-2 border-black p-1 lg:p-3 rounded-lg mx-auto hover:bg-red-600">Drop Full Team</button></div>
