...
<nav className="bg-gray-400  fixed w-full z-20 top-0 start-0 border-b border-gray-200 ">
  <div className="max-w-screen-2xl flex  items-center justify-between mx-auto p-4">
  <div  className="flex items-center ">
      <img src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="Player Pick Logo"/>
      <span className="self-center text-lg lg:text-3xl font-bold whitespace-nowrap ">Players Pick Pavilion</span>
  </div>
  <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
     ...
     <button
      ...
      {/* Your collapsible menu content here, controlled by the 'isMenuOpen' state */}
      {isMenuOpen && (
